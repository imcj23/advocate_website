          ...
          <div className="flex flex-col justify-between rounded-sm bg-[#001311] p-7 text-white md:p-9">
            <div>
              ...
              <p className="max-w-xl text-sm leading-7 text-white/75 md:text-base">
                "Office Name" adalah firma hukum butik yang dibangun berdasarkan
                prinsip sederhana: nasihat hukum harus memberikan kejelasan dan
                arah, bukan sekadar mengidentifikasi risiko.
              </p>
              ...
              <p className="mt-4 max-w-xl text-sm leading-7 text-white/75 md:text-base">
                ...
                eksekutif, dan klien perorangan mengenai berbagai masalah hukum
                yang kompleks, baik yang berkaitan dengan kegiatan usaha,
                korporasi, maupun sengketa. Layanan kami memadukan keahlian
                hukum dengan pemahaman praktis yang berorientasi pada aspek
                komersial serta berfokus pada pencapaian hasil yang bermakna
                bagi klien.
              </p>
            </div>
